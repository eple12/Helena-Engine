...
// // region Zero
//     const int32_t MaterialValues[] = { S(100, 100), S(300, 300), S(300, 300), S(500, 500), S(900, 900) };
//     const int32_t BishopPairBonus = S(0, 0);
//     const int32_t OutpostBonus = S(0, 0);
//     const int32_t OpenFileBonus = S(0, 0);
//     const int32_t SemiFileBonus = S(0, 0);
//     const int32_t PassedPawnBonus[] = { S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0) };
//     const int32_t PassedPawnProtectedBonus = S(0, 0);
//     const int32_t PassedPawnBlockedPenalty[] = { S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0) }; // Knight, Bishop, Rook, Queen, King
//     const int32_t DoubledPawnPenalty = S(0, 0);
//     const int32_t IsolatedPawnPenaltyByCount[] = { S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0) };
//     const int32_t PawnShelterMissingPenalty = S(0, 0);
//     const int32_t PawnShelterWeakPenalty = S(0, 0);
//     const int32_t KingFileOpenPenalty = S(0, 0);
//     const int32_t KingFileSemiOpenPenalty = S(0, 0);
//     const int32_t PawnStormPenaltyByDistance[] = { S(0, 0), S(0, 0), S(0, 0), S(0, 0) }; // [0-3]
    
//     // Mobility bonuses
//     const int32_t KnightMobilityBonus[] = { S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0) }; // [0-8]
//     const int32_t BishopMobilityBonus[] = { S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0) }; // Max 13
//     const int32_t RookMobilityBonus[] = { S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0) }; // Max 14
//     const int32_t QueenMobilityBonus[] = { S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0) }; // Max 27

//     // Mop-up constants (non-tunable, from EvaluationConstants.cs)
//     const int32_t CloserToEnemyKing = S(0, 0);
//     const int32_t EnemyKingCorner = S(0, 0);
...
// Main trace function
static Trace trace_evaluate(const Board& board, Trace& trace) {
...
EvalResult HelenaEval::get_external_eval_result(const chess::Board& board) {
    Trace trace{};
    trace = trace_evaluate(board, trace);
